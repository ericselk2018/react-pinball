...
export const rightFlipperHoldCoil: Coil = { name: 'Right Flipper Hold', id: id(2) };
export const rightFlipperMainCoil: Coil = { name: 'Right Flipper', id: id(3) };
...
export const topKickerCoil: Coil = { name: 'Top Kicker', id: id(0) };
export const leftBumperCoil: Coil = { name: 'Left Bumper', id: id(1) };
export const leftKickerCoil: Coil = { name: 'Left Kicker', id: id(2) };
export const topRightKickerCoil: Coil = { name: 'Top Right Kicker', id: id(3) };
export const middleBumperCoil: Coil = { name: 'Middle Bumper', id: id(4) };
export const rightBumperCoil: Coil = { name: 'Right Bumper', id: id(5) };
export const rightKickerCoil: Coil = { name: 'Right Kicker', id: id(6) };
