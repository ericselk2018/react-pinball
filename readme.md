...
Above example is using an npm package for the serve command. I was not able to avoid having a web server because Chrome does not save the serial port access when run using the file:// protocol.
